...
export default function FormRegistrationPartner() {
    ...
    if (isSubmit) {
        ...
        console.log(options)
        if (isSignup) {
            fetch("http://localhost:8080/partner_signin", options)
                .then(data => {
    ...
    return (
        <div className='Background'>
            ...
            >
                <Typography>
                    {!isSignup ? "Inscription entreprise" : "Connexion entreprise"}
                </Typography>
                ...
                <TextField
                    ...
                    margin='normal'
                    type={'email'}
                    placeholder="Adresse e-mail entreprise"
                />
                ...
                <Button
                    ...
                    sx={{marginTop: 3, borderRadius: 3}}
                >
                    {!isSignup ? "Connexion entreprise" : "Inscription entreprise"}
                </Button>
                {errorMessage === '' ? null :
                    <Typography>
                        {errorMessage}
