...
func calc_score(materials string, type_ string, water int, gaz int, origin string) (result int) {
	score := 5
...
func calc_water_consommation(type_ string) (result int) {
	if (type_ == "haut") {
	    return 1300
	}
	if (type_ == "bas") {
...
func calc_gaz_consommation(type_ string) (result int) {
	if (type_ == "haut") {
        return 10
	}
	if (type_ == "bas") {
...
func calc_gaz_score(type_ string) (result int) {
	if (type_ == "haut") {
        return 4
	}
	if (type_ == "bas") {
